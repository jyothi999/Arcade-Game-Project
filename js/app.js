...
Player.prototype.handlePlayerChar = function() {};
...
class Queen {
  ...
  //Draw Queen sprite on current x & y
  render() {
    ctx.drawImage(Resources.get(this.sprite), this.x, this.y);
  }
  // @param {string} input
...
const player = new Queen();
const bug1 = new Enemy(-101, 0, 200);
const bug2 = new Enemy(-101, 83, 300);
const bug3 = new Enemy(-101 * 2.5, 83, 300);
const bug4 = new Enemy(-101, 0, 100);
const allEnemies = [];
